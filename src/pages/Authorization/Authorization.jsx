      ...
      <section className={styles.autorization}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'row-reverse' }}>
            ...
            {/* <ButtonExit title="Сгенерировать токен" route="/" /> */}
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', marginBottom: '30px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'row-reverse' }}>
            ...
            {/* <ButtonExit title="Зарегистрироваться" route="/" /> */}
          </div>
        </div>
        {/* <button style={{ marginTop: '30px' }} onClick={() => { setUserToken(''); setUserTokenGen(''); setCurrentUser(''); api.setToken(''); setPage0(''); }}>Выйти</button> */}
        ...
        <section className={styles.autorization}>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div>
                    ...
                    {/* <ButtonExit title="Выход" route="/" fnExit={Exit} /> */}
                    <ButtonExit title="Выход" route="/" fn={Exit} />
                  </div>
          </div>
        </section>
      </>
